<?php
    ...
    if(!isset($_POST['friendId'])){
        ...
        if($friend_num == 1){
            ...
            Database::insert_update_delete("UPDATE `friend` SET `friend_status_fs_id` = '3' WHERE `friend_id` = '".$friend_id."' ");

            echo("success");
        }
        else{
            echo("Friend request rejection faild. Please try again later");
        }
    }
?>